...
export default function ReportPage() {
    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-start pt-8 pb-24 px-4 bg-[var(--background)]">
            ...
            <div className="w-full max-w-lg lg:max-w-7xl lg:grid lg:grid-cols-12 lg:gap-8 lg:items-start">

                {/* LEFT COLUMN - Mappa Operativa */}
                <div className="w-full mb-6 lg:mb-0 lg:col-span-5 lg:sticky lg:top-24">
                ...
                <div className="w-full lg:col-span-7 space-y-6">
                    ...
                    <div className="w-full glass-card space-y-4">
                    ...
                    {/* Report Result */}
                    {report && (
                        <div className="w-full mt-6 glass-card border-[var(--primary)] animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <button
                        ...
                        disabled={!report}
                        className="w-full mb-12 bg-gray-800 hover:bg-gray-900 text-white font-bold py-4 rounded-xl shadow-lg flex justify-center items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                    >
